...
const SkillsForm = ({ data, onChange }) => {
  ...
  // Defensive guards: ensure `skills` is always an array and `safeOnChange` is callable
  ...
  const addSkill = () => {
    ...
    if (trimmed && !skills.includes(trimmed)) {
      safeOnChange([...skills, trimmed]);
      setNewSkill("");
    }
  };

  const removeSkill = (indexToRemove) => {
    safeOnChange(skills.filter((_, index) => index !== indexToRemove));
  };
