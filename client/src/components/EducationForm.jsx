       ...
       <div className='space-y-4'>
        <div className='flex items-center justify-between'>
           ...
           <button onClick={addEducation} className='flex items-center gap-2 px-3 py-1 text-sm bg-green-100 
             text-green-700 rounded-lg hover:bg-green-200 transition-colors disabled:opacity-50'> 
                   ...
                   <div className='flex justify-between items-start'>
                    ...
                    <div className='grid md:grid-cols-2 gap-3'>
                       ...
                       onChange={(e)=>updateEducation(index,"degree" , e.target.value)}
                        placeholder='Degree (e.g., Bachelor Master' className='px-3 py-2 text-sm'/> 

                       <input type='text'  value={education.field|| ""} 
                      ...
                      <input type='text'  value={education.gpa|| ""} 
                       onChange={(e)=>updateEducation(index,"gpa" , e.target.value)}
                        className='px-3 py-2 text-sm' placeholder='GPA (optional)'/> 
                </div>
             ))}
          </div>
        )}
